...
class ZendeskClient {
  ...
  async countTicketComments(id) {
    return this.request('GET', `/tickets/${id}/comments/count.json`);
  }

  async getTicketComment(ticketId, commentId) {
    return this.request('GET', `/tickets/${ticketId}/comments/${commentId}.json`);
  }
